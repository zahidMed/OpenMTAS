...
public class Ringing extends CallState {
	...
	public void onResponse(CallContext context, SipServletResponse response, int method)
		...
		else if(response.getStatus()==SipServletResponse.SC_RINGING || response.getStatus()==SipServletResponse.SC_SESSION_PROGRESS)
		{
